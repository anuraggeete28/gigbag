 ...
 */
class Webservice_general_model extends CI_Model {
    ...
    public function getDataArray($tableName = '', $filters = array(),$select = '',$orderBy = '', $orderFormat = 'desc',$join = array()) {
        /* Add Select arguments */
        if ($select != '')
            $this->db->select($select);
        /* Add Filters */
    ...
    public function sendPushNotification($message,$token){
        //$token = "faRVjVFEgAs:APA91bFfjS-YRxA05T4b_QE_dJRNHQuZ_asuVOIxS_kE0Im-t7l4ctKeiywnTALXswEaI94CoA1mFVHIjqhSAKpoBD9_DDdwTmtrH5ScHy8kgOSLGmcnBuDXWXecZ7U3mzM5XLrIQOp_";
        //$message="Good evening all";
        $path_to_firebase_cm = 'https://fcm.googleapis.com/fcm/send';

        $fields = array(
            'to' => $token,
            'data' => array('title' => 'Rekarto', 'body' => $message),
            'data' => array('message' => $message)
        );

        $headers = array(
            'Authorization:key=AIzaSyBQie78ODA5k4vSnca5YFA9b6A2fOYELWs',
