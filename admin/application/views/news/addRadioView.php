                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form class="form-horizontal" id="RegisterValidation" action="<?= base_url(); ?>News/add_radio" method="POST" enctype="multipart/form-data"> 
                                        ...
                                        <div class="form-group">
                                            <textarea cols="150" id="message" name="content" rows="10" placeholder="Description" data-sample-short><?php if(isset($media_detail)){ print_r($media_detail->content); } ?></textarea>
                                        </div>
                          ...
                          <?php }  ?>
                                        ...
                                        <input type="hidden" name="radioID"  id="radioID" value="<?php if(isset($media_detail)){ echo $media_detail->news_id; } ?>" /> 
                                        <button type="submit" name="add_radio" value="Update" class="btn btn-dark mb-2">Add News</button>
                                    </form>
                                </div>
                            </div>
                        </div>
