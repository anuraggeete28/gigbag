...
.csvdownload{
    ...
    float:right;
            ...
            <div class="container-fluid">
                <div class="row">
                 ...
                 <a href="<?php echo base_url() ?>Categories/add" class="btn btn-primary">Add category</a>
  ...
  <style>
                ...
                <div class="row csvdownload">
                    <button class="btn btn-primary"><a style = "color:white;margin-top:-10px;"href='<?= base_url() ?>Exportsubcat/export'>Download Category Data</a></button>
