...
<body>
    ...
    <![endif]-->     
    <section class="fxt-template-animation fxt-template-layout7" data-bg-image="<?php echo base_url(); ?>asset/img/bg7-l.png">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-6 col-lg-7 col-sm-12 col-12 fxt-bg-color">
                    <div class="fxt-content">
                        <div class="fxt-header">
                            <!--<a href="login-7.html" class="fxt-logo"><img src="<?php //echo base_url(); ?>asset/img/logo-7.png" alt="Logo"></a>-->                        
                            <p>Login into your Dashboard account</p>
                        </div>                            
                        <div class="fxt-form"> 
