...
echo $query->num_rows(); 
                            ?></h2>
                            <h6 class="text-uppercase font-size-11 mb-2 text-primary font-weight-bold"><a href="<?=base_url()?>Student/">Students</a></h6>
...
echo $query->num_rows(); 
                            ?></h2>
                            <h6 class="text-uppercase font-size-11 mb-2 text-success font-weight-bold"><a href="<?=base_url()?>Teachers/">Coach</a></h6>
                            <p class="m-0 small text-muted"></p>
                            </center>
                        </div>
                        <div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h6 class="text-uppercase font-size-11 mb-2 text-warning font-weight-bold"><a href="<?=base_url()?>Subcategory/">Sub Category</a></h6>
                            <p class="m-0 small text-muted"></p>
                            </center>
                        </div>
                        <div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <center>
                            <h2 class="font-weight-bold mb-2"><?php echo $this->db->count_all('gigs');  ?></h2>
                            <h6 class="text-uppercase font-size-11 mb-2 text-info font-weight-bold"><a href="<?=base_url()?>Category/">Gigs</a></h6>
                            <p class="m-0 small text-muted"></p>
                            </center>
                        </div>
                        <div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h6 class="text-uppercase font-size-11 mb-2 text-info font-weight-bold"><a href="<?=base_url()?>Coupon/">Coupon</a></h6>
                            <p class="m-0 small text-muted"></p>
                            </center>
                        </div>
                        <div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h6 class="text-uppercase font-size-11 mb-2 text-primary font-weight-bold"><a href="<?=base_url()?>Webdashboard/">Website Contents</a></h6>
                            <p class="m-0 small text-muted"></p>
                            </center>
                        </div>
                        <div>
