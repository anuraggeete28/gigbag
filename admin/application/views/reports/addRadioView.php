...
<?php
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form class="form-horizontal" id="RegisterValidation" action="<?= base_url(); ?>Reports/add_radio" method="POST" enctype="multipart/form-data"> 
                                       ...
                                       <input type="hidden" name="short_desc" value="Report is the latest study published by Gravitas Market Insights. It offers global industry analysis for 2014-2020 and valuates opportunities and forecast data for 2021-2028. This report covers Market Overview along with market background, Market Trends, Demand Analysis, Analysis of COVID-19 Impact, Segment Overview, Regional Profiling, Overall market structure and in-depth Competitive Analysis. Additionally, key activities related to the market strategies which includes mergers and acquisitions, product advancements, etc., are discussed." />
    ...
    <script src="https://www.crystalmarketresearch.com/media/backend/js/ckeditor/ckeditor.js"></script>
  <script>
